...
class Persistence  {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        ...
        let className:String = "Persistence";
        let funcName = "applicationDocumentsDirectory";
        let urls = NSFileManager.defaultManager().URLsForDirectory(.DocumentDirectory, inDomains: .UserDomainMask)
        Logging.debug(className, methodName: funcName, logline:"db url \(urls[urls.count-1])");
        return urls[urls.count-1] as NSURL
        }()
    
    lazy var model: NSManagedObjectModel = {
        let modelName:String = "RipplModel"
    ...
    lazy var psc: NSPersistentStoreCoordinator? = {
        let databaseName = "DropDB2.sqlite"
    ...
    init() {
     ...
     /*
        ...
        println("database storeURL \(storeURL)")
